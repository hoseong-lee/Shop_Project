...
import ShopView.BasketController;
...
public class ShopDetailsServiceImpl implements ShopDetailsService{
	private BasketController basketCtrlr;
...
//			System.out.println("할인x");
	...
	public Popup OpenbasketForm(ArrayList<String> info) {
		...
		basketCtrlr =new BasketController();
		Popup basketPopup;
		
	
		System.out.println(info);
		
		basketPopup = basketCtrlr.SetCartInfo(info);
		
		sdctrler.setBasketPopup(basketPopup);
